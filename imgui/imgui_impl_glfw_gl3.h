...
//	jelo add
IMGUI_API void		  ImGui_ImplGlfwGL3_SetCurrentWindow ( void* handle ) ;
IMGUI_API void		  ImGui_ImplGlfwGL3_UpdateMouse () ;
IMGUI_API void		  ImGui_ImplGlfwGL3_CreateWindow ( GLFWwindow* window , unsigned int width , unsigned int height ) ;
IMGUI_API void		  ImGui_ImplGlfwGL3_RenderDrawListsEx(ImDrawData* draw_data);
IMGUI_API void		  ImGui_ImplGlfwGL3_ShutdownEx() ;
//	jelo
