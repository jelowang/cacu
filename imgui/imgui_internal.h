...
namespace ImGui
{
    ...
    inline    ImGuiWindow*  GetCurrentWindowRead()      { ImGuiState& g = (*(ImGuiState *)ImGui::GetCurrentGuiState ()) ; return g.CurrentWindow; }
    inline    ImGuiWindow*  GetCurrentWindow()          { ImGuiState& g = (*(ImGuiState *)ImGui::GetCurrentGuiState ()) ; g.CurrentWindow->Accessed = true; return g.CurrentWindow; }
