...
namespace ImGui
{
	...
	//	jelo add start
	IMGUI_API bool			TreeNodeVJelo(const void* ptr_id,bool open, const char* fmt, va_list args) ;
	IMGUI_API bool			TreeNodeJelo(const void* str_id, bool open , const char* fmt, ...) ;
	IMGUI_API bool			CollapsingHeaderJelo(const char* label, const char* str_id, bool display_frame, bool default_open,bool collapsingOpen ) ;
	//	jelo add end
	...
	//	jelo add start
	IMGUI_API void*			GetCurrentGuiState () ;
	//	jelo add end
